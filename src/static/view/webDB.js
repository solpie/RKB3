...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Navbar_1 = __webpack_require__(106);
	var GameMonth_1 = __webpack_require__(108);
	var routes = [
	    {
	        path: '/', name: 'home',
	        components: { content: GameMonth_1.gameMonthView, Navbar: Navbar_1.Navbar }
	    }
	];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__webpack_require__(6)(__webpack_require__(17))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__webpack_require__(6)(__webpack_require__(19))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function getEventConf(event_id, callback) {
	    var url = 'http://rtmp.icassi.us:8090/event?event_id=' + event_id;
	    _get(WebJsFunc_1.proxy(url), callback);
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var RawDayClient_1 = __webpack_require__(109);
	var RawDayInfo_1 = __webpack_require__(110);
	var CampusInfo_1 = __webpack_require__(113);
	var thenBy_1 = __webpack_require__(114);
	var JsFunc_1 = __webpack_require__(23);
	var GameInfo_1 = __webpack_require__(115);
	var WebDBCmd_1 = __webpack_require__(69);
	...
	var rawdayInfo = new RawDayInfo_1.RawDayInfo([]);
	var livedata;
	...
	var GameMonth = (function (_super) {
	    ...
	    function GameMonth() {
	        ...
	        _this.template = __webpack_require__(116);
	        _this.db = VueBase_1.VueBase.PROP;
	        _this.isOld = VueBase_1.VueBase.PROP;
	        _this.recMap = VueBase_1.VueBase.PROP;
	        _this.gameInfo = VueBase_1.VueBase.PROP;
	        _this.playerRank = VueBase_1.VueBase.PROP;
	        _this.masterBracket = VueBase_1.VueBase.PROP;
	        _this.gameInfoStr = VueBase_1.VueBase.PROP;
	        _this.vs = VueBase_1.VueBase.PROP;
	        _this.campusPlayer = VueBase_1.VueBase.PROP;
	        _this.campusInput = VueBase_1.VueBase.PROP;
	        _this.campusL = VueBase_1.VueBase.PROP;
	        _this.campusR = VueBase_1.VueBase.PROP;
	        _this.campusWinScore = VueBase_1.VueBase.PROP;
	        _this.campusGameIdx = VueBase_1.VueBase.PROP;
	        _this.rawdayInfo = VueBase_1.VueBase.PROP;
	        _this.methods = {
	            onCreateCampus: function (t) {
	            ...
	            onStartCampus: function () {
	                ...
	                var data = campusInfo.getData(this.campusL, this.campusR);
	            ...
	            onSetMaster: function () {
	                var _this = this;
	                getDoc(function (doc) {
	                    var sumMap = gameInfo.buildPlayerData(doc);
	                    ...
	                    var groupMap = { 'a': [], 'b': [], 'c': [], 'd': [] };
	                    for (var _b = 0, playerArr_3 = playerArr; _b < playerArr_3.length; _b++) {
	                        var p3 = playerArr_3[_b];
	                        var pg = p3.name[0];
	                    ...
	                    for (var _c = 0, m_1 = m; _c < m_1.length; _c++) {
	                        var m1 = m_1[_c];
	                        console.log('master', m1.name);
	                    }
	                    console.log('master', m);
	                    _this.masterBracket = m;
	                    saveDoc(doc);
	                    _this.renderRecMap(doc['recMap']);
	                });
	            },
	            onBracket: function () {
	                this.routeBracket();
	            ...
	            onHideProgress: function () {
	                $post("/db/cmd/" + WebDBCmd_1.WebDBCmd.cs_hideProgress, { _: null }, null);
	            },
	            onSetResult: function () {
	                var _this = this;
	                getDoc(function (doc) {
	                    var r = doc['recMap'][gameInfo.gameIdx];
	            ...
	            onCommitGame: function (isEmit) {
	                ...
	                getDoc(function (doc) {
	                    if (doc) {
	                        ...
	                        var sum = gameInfo.getWinInfo(doc, data.player.name);
	    ...
	    GameMonth.prototype.created = function () {
	        ...
	        var srvIO = io.connect('/webDB')
	            ...
	            .on(WebDBCmd_1.WebDBCmd.init, function () {
	            console.log('rawday init');
	        });
	        this.campusWinScore = 2;
	        this.campusGameIdx = 1;
	    };
	    GameMonth.prototype.routeBracket = function () {
	        var _this = this;
	        var masterIdx = 23;
	        var route = function (from, toWin, toLose) {
	            from += masterIdx;
	            toWin += masterIdx;
	            toLose += masterIdx;
	            var rFrom = _this.recMap[from];
	            var rWin = _this.recMap[toWin];
	            var rLose = _this.recMap[toLose];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var WebDBCmd_1 = __webpack_require__(69);
	var JsFunc_1 = __webpack_require__(23);
	var PlayerInfo_1 = __webpack_require__(111);
	var RawDayCmd_1 = __webpack_require__(112);
	var srvIO;
	var rawDayClient;
	var $post = function (url, param, callback) {
	    $.ajax({
	...
	var RawDayInfo = (function () {
	    ...
	    RawDayInfo.prototype.onEvent = function (event) {
	        if (event == 'emitInfo') {
	            ...
	            rawDayClient = new RawDayClient_1.RawDayClient();
	        }
	    ...
	    RawDayInfo.prototype.emitInfo = function () {
	        this.emit_init();
	        this.emit_list();
	    };
...
/***/ (function(module, exports) {
	...
	var CampusInfo = (function () {
	    ...
	    CampusInfo.prototype.create = function (t) {
	        var rowArr = t.split('\n');
	        var dataMap = {};
	    ...
	    CampusInfo.prototype.getData = function (lId, rId) {
	        var data = { _: null };
	        data.winScore = 2;
	        data.matchType = 1;
	        data.status = 2;
	    ...
	    CampusInfo.prototype.getPlayer = function (lId) {
	        var p = this.playerMap[lId];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var GameInfo = (function () {
	    ...
	    GameInfo.prototype.getGameArr = function () {
	        var gmi = this;
	        var group = [];
	        for (var i = 0; i < 4; i++) {
	    ...
	    GameInfo.prototype.h = function (name) {
	    ...
	    GameInfo.prototype.getBracket = function () {
	        ...
	        for (var i = 24; i < 38; i++) {
	            var r = this.recMap[i];
	            var lPlayer = this.getPlayerInfo(r.player[0]);
	            var rPlayer = this.getPlayerInfo(r.player[1]);
	            data[i - 23] = {
	                left: {
	                    score: r.score[0],
	                    name: lPlayer.hupuID
	    ...
	    GameInfo.prototype.getPlayerData = function () {
	        var data = {};
	        var lName = this.recMap[this.gameIdx].player[0];
	    ...
	    GameInfo.prototype.getWinInfo = function (doc, playerName) {
	        var sumMap = this.buildPlayerData(doc, true);
	        for (var groupId in this.nameMapHupuId) {
	    ...
	    GameInfo.prototype.getGroup = function (doc, group) {
	        var sumMap = this.buildPlayerData(doc);
	        var playerArr = [];
	        for (var i = 0; i < 4; i++) {
	            var data = sumMap[group + (i + 1)];
	            var p = this.getPlayerInfo(data.name);
	            data.name = p.hupuID;
	    ...
	    GameInfo.prototype.buildPlayerData = function (doc, isAll) {
	    ...
	    GameInfo.prototype.setVS = function (doc, groupNameArr) {
	        var r = doc['recMap'][this.gameIdx];
	    ...
	    GameInfo.prototype.commit = function () {
	        var lPlayer = { name: this.recMap[this.gameIdx].player[0] };
	        var rPlayer = { name: this.recMap[this.gameIdx].player[1] };
	        var winner;
	        if (this.lScore > this.rScore) {
	            winner = lPlayer;
	        }
