...
/***/ function(module, exports, __webpack_require__) {
	...
	function getPlayer_baseinfo(player_id, callback) {
	    var url = 'http://www.liangle.com/api/passerbyking/player/baseinfo/' + player_id;
	    _get(WebJsFunc_1.proxy(url), callback);
	}
	exports.getPlayer_baseinfo = getPlayer_baseinfo;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ScoreRankAdmin = (function (_super) {
	    ...
	    function _ScoreRankAdmin() {
	        ...
	        this.game_id_input = VueBase_1.VueBase.PROP;
	        this.methods = {
