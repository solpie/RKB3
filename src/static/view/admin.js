...
/***/ function(module, exports, __webpack_require__) {
	...
	var routes = [
	    ...
	    },
	    {
	        ...
	        components: { content: player_1.playerView },
	    },
	];
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/.0.25.0@css-loader/index.js?root=.!./worldwar.css", function() {
				var newContent = require("!!./../../../node_modules/.0.25.0@css-loader/index.js?root=.!./worldwar.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/.0.25.0@css-loader/index.js?root=.!./cropper.min.css", function() {
				var newContent = require("!!./../../../node_modules/.0.25.0@css-loader/index.js?root=.!./cropper.min.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HomeView = (function (_super) {
	    ...
	    function HomeView() {
	        ...
	        this.player_id = VueBase_1.VueBase.PROP;
	        ...
	        this.playerArrStr = VueBase_1.VueBase.PROP;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function postRank16(rankData, callback) {
	    var url = "http://test.liangle.com/manage/create/game/jifen/";
	    console.log('postRank16', rankData);
	    WebJsFunc_1.$post(WebJsFunc_1.proxy(url), rankData, callback);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GameAdmin = (function (_super) {
	    ...
	    function _GameAdmin() {
	        ...
	        this.vsPlayerArr = VueBase_1.VueBase.PROP;
	        this.gameTitle = VueBase_1.VueBase.PROP;
	        this.redArr = VueBase_1.VueBase.PROP;
	        this.blueArr = VueBase_1.VueBase.PROP;
	        this.lPlayer = VueBase_1.VueBase.PROP;
	        this.rPlayer = VueBase_1.VueBase.PROP;
	        this.lastScoreArr = VueBase_1.VueBase.PROP;
	        this.methods = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _worldWar = (function (_super) {
	    ...
	    function _worldWar() {
	        ...
	        this.components = { BaseGame: BaseGame_1.BaseGameView };
	        this.vsPlayer = VueBase_1.VueBase.PROP;
	        this.vsPlayerArr = VueBase_1.VueBase.PROP;
	        this.redArr = VueBase_1.VueBase.PROP;
	        this.blueArr = VueBase_1.VueBase.PROP;
	        this.recArr = VueBase_1.VueBase.PROP;
	        this.teamVsIdx = VueBase_1.VueBase.PROP;
	        this.teamScore = VueBase_1.VueBase.PROP;
	        this.isShowCurTeamVsOnly = VueBase_1.VueBase.PROP;
	        this.updateTime = VueBase_1.VueBase.PROP;
	        this.delay = VueBase_1.VueBase.PROP;
	        this.watch = {
	    ...
	    _worldWar.prototype.emitKDA = function (v) {
	        ...
	        var _ = function (arr, scoreArr) {
	            for (var _i = 0, arr_1 = arr; _i < arr_1.length; _i++) {
	                ...
	                p.avatar = _this.gameView.data.avatarUrlBase + p.playerId + ".png";
	                p.isSmall = true;
	                p.score = p.blood;
	                scoreArr.push(p);
	            }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var JsFunc_1 = __webpack_require__(21);
	var VueBase_1 = __webpack_require__(22);
	var bracketRec_1 = __webpack_require__(135);
	var confFile = null;
	var reader;
	var filesInput;
	var dbUrl;
	...
	var _ScoreRankAdmin = (function (_super) {
	    ...
	    function _ScoreRankAdmin() {
	        ...
	        this.rPlayer = VueBase_1.VueBase.PROP;
	        this.lastScoreArr = VueBase_1.VueBase.PROP;
	        this.selGameIdx = VueBase_1.VueBase.PROP;
	        this.recArr = VueBase_1.VueBase.PROP;
	        ...
	        this.methods = {
	            ...
	            onGenRank16: function (rank5Player) {
	                var _this = this;
	                syncDoc(function (data) {
	                    _this.rank16Arr = bracketRec_1.rank16(data.doc, _this.playerMap, rank5Player);
	                });
	            },
	            onEmitBracket: function () {
