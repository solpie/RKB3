...
/***/ function(module, exports, __webpack_require__) {
	...
	var _worldWar = (function (_super) {
	    ...
	    function _worldWar() {
	        ...
	        this.vsPlayerArr = VueBase_1.VueBase.PROP;
	        this.redArr = VueBase_1.VueBase.PROP;
	        this.redArr_2 = VueBase_1.VueBase.PROP;
	        this.blueArr = VueBase_1.VueBase.PROP;
	        this.recArr = VueBase_1.VueBase.PROP;
	        this.blueArr_2 = VueBase_1.VueBase.PROP;
	        this.teamVsIdx = VueBase_1.VueBase.PROP;
	        this.teamScore = VueBase_1.VueBase.PROP;
	        this.playerDots = VueBase_1.VueBase.PROP;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ScoreRankAdmin = (function (_super) {
	    ...
	    function _ScoreRankAdmin() {
	        ...
	        this.rank5PlayerArr = VueBase_1.VueBase.PROP;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PickTeamAdmin = (function (_super) {
	    ...
	    function _PickTeamAdmin() {
	        ...
	        this.selected_player = VueBase_1.VueBase.PROP;
	        this.confType2_playerMap = VueBase_1.VueBase.PROP;
	        this.confType4 = VueBase_1.VueBase.PROP;
	        this.methods = {
