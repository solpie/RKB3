...
//     getRec() {
//         return {
//             left: {score: Number(this.leftScoreText.text), name: this._playerName[0]},
//             right: {score: Number(this.rightScoreText.text), name: this._playerName[1]}
//         }
//     }
...
//     setPlayerName(param: string[]) {
//         this._playerName = param;
//     }
// }